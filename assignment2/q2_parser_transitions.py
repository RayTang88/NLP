class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if transition == "S":
            ...
            LEN = len(self.stack) - 1
            self.dependencies.append((self.stack[LEN], self.stack[LEN-1]))
            del self.stack[LEN-1]
        elif transition == "RA":
            LEN = len(self.stack) - 1
            self.dependencies.append((self.stack[LEN-1], self.stack[LEN]))
            del self.stack[LEN]
        ### END YOUR CODE
